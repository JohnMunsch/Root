...
*This source code is current with the 2.0.0 final release of Angular 2 with the exception of the Video 6.2 and 6.3 examples (I haven't got the unit tests working with the new code yet).*
